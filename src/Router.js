...
const Router = () => {
  return (
    <Routes>
      ...
      <Route path="/protectedlisting" element={<ProtectedRoute component={ProtectedListings} />}></Route>
      <Route path="/addlisting" element={<ProtectedRoute component={AddListing} />}></Route>
    </Routes>
  );
};
